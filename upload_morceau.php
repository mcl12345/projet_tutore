...
function formulaire_upload($db_host_, $db_name_, $db_user_, $db_password_) {
    echo "<div class='row'>
        ...
        <div class='col-lg-4'>
          <div class='container'>
              <form method='post' action='upload_morceau.php' enctype='multipart/form-data'>
...
if(isset($_POST['titre']) && isset($_POST['genre']) && isset($_POST['artiste']) && isset($_FILES['the_music']['name'])) {
  ...
  if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
  {
       ...
       if(move_uploaded_file($_FILES['the_music']['tmp_name'], $dossier . $fichier_musique) &&
       move_uploaded_file($_FILES['the_image']['tmp_name'], $dossier_image . $fichier_image))
       {
